...
// configuration step. It creates a namespace called `Izgrad`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Izgrad::cmake::project_name, Izgrad::cmake::project_version) };
